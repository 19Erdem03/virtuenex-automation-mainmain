        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/pricing" className="text-sm text-gray-500 hover:text-gray-300 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/blogs" className="text-sm text-gray-500 hover:text-gray-300 transition-colors">
                  Blogs
                </Link>
              </li>
              <li>
